...
uint32_t tinyUSBBuffer[ 2048 ];
osStaticThreadDef_t tinyUSBControlBlock;
const osThreadAttr_t tinyUSB_attributes = {
  .name = "tinyUSB",
  .cb_mem = &tinyUSBControlBlock,
  .cb_size = sizeof(tinyUSBControlBlock),
  .stack_mem = &tinyUSBBuffer[0],
